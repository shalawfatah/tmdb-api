...
const FirstMovie = ({item}) => {
  return (
    <Link href={`../../../movies/${item?.id}`}>
        <div
        style={{backgroundImage: `url(${'https://image.tmdb.org/t/p/original/' + item?.poster_path})`, backgroundSize: 'cover', backgroundOrigin: 'center'}}
        className="bg-[#161616] p-4 min-h-[500px] text-white flex flex-col justify-end shadow-xl shadow-gray-500"
        >
